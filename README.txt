...
a persistence unit "ExamenRecuperacionServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenRecuperacionServidor\pom.xml":
...
artifact ("ExamenRecuperacionServidor.war") is already built. You can build
